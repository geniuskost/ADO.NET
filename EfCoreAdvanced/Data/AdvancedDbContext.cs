...
namespace EfCoreAdvanced.Data
{
    public class AdvancedDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("server=(localdb)\\mssqllocaldb;database=moviesadvanceddb;trusted_connection=true;trustservercertificate=true;");
        }
